...
// node_modules/shader3/dist/shader3.esm.js
var o = (e, o2) => {
  e = e.split("\n").map((e2) => e2.replace(/[ \t]+(?=[^\s])/g, " ").trim()).filter((e2) => e2.length > 0).join("\n").replace(/(\n\s*){2,}/g, "\n");
  const [t2, r2] = e.split("void main");
  return { header: t2, mainBody: r2.trim().slice(0, -1).replace("{", "___|Temp|___").split("___|Temp|___")[1] };
};
var t = class extends MeshStandardMaterial {
  constructor(e) {
    super(e), e && v(this, e);
  }
};
var r = class extends MeshPhysicalMaterial {
  constructor(e) {
    super(e), e && v(this, e);
  }
};
var n = class extends MeshDepthMaterial {
  constructor(e) {
    super(e), e && v(this, e);
  }
};
var c = class extends MeshMatcapMaterial {
  constructor(e) {
    super(e), e && v(this, e);
  }
};
var i = class extends ShaderMaterial {
  constructor(o2) {
    var t2, r2, n2, c2, i2, v2, x2, a2, l2, f2, g, s, m, d;
    super(Object.assign({ vertexShader: "\n#include <common>\n#include <fog_pars_vertex>\n#include <shadowmap_pars_vertex>\n#include <skinning_pars_vertex>\nuniform float frame;uniform float glitchStrength;uniform float glitchMin;uniform float glitchMax;uniform float glitchFrequencyLow;uniform float glitchFrequencyMid;uniform float glitchFrequencyHigh;varying vec3 vPosition;varying vec3 vNormal;varying vec2 vUv;varying vec3 fogPosition;varying vec3 vWorldPosition;float random2D(vec2 value){return fract(sin(dot(value.xy,vec2(12.9898,78.233)))*43758.5453123);}void main(){\n#include <skinbase_vertex>\n#include <begin_vertex>\n#include <beginnormal_vertex>\n#include <defaultnormal_vertex>\nvec4 worldPosition=modelMatrix*vec4(position,1.0);\n#include <skinning_vertex>\n#include <project_vertex>\n#include <shadowmap_vertex>\n#include <fog_vertex>\nfogPosition=mvPosition.xyz;vWorldPosition=worldPosition.xyz;vec4 modelPosition=mvPosition;float glitchTime=frame-modelPosition.y;float strength=sin(glitchTime*glitchFrequencyLow)+sin(glitchTime*glitchFrequencyMid)+sin(glitchTime*glitchFrequencyHigh);strength/=3.0;strength=smoothstep(glitchMin,glitchMax,strength);strength*=glitchStrength;modelPosition.x+=(random2D(modelPosition.xy+frame)-0.5)*strength;modelPosition.z+=(random2D(modelPosition.zx+frame)-0.5)*strength;gl_Position=projectionMatrix*modelPosition;vPosition=modelPosition.xyz;vNormal=(modelMatrix*vec4(normal,0.0)).xyz;vUv=uv;}", fragmentShader: "uniform float frame;uniform vec3 color;uniform float stripCount;uniform float fresnelExponent;uniform float holographicOffset;uniform float smoothEdgeStart;uniform float smoothEdgeEnd;uniform sampler2D map;uniform bool useMap;varying vec3 vPosition;varying vec3 vNormal;varying vec2 vUv;void main(){vec3 normal=normalize(vNormal);float strips=mod((vPosition.y-frame*.02)*stripCount,1.);strips=pow(strips,3.);vec3 viewDirection=normalize(vPosition-cameraPosition);float fresnel=1.-abs(dot(viewDirection,normalize(normal)));fresnel=pow(fresnel,fresnelExponent);float holographic=fresnel*strips;holographic+=fresnel*holographicOffset;holographic*=smoothstep(smoothEdgeStart,smoothEdgeEnd,fresnel);vec4 mapColor=useMap ? texture2D(map,vUv): vec4(1.0);gl_FragColor=vec4(color*mapColor.rgb,holographic);\n#include <tonemapping_fragment>\n#include <colorspace_fragment>\n}", transparent: true, side: DoubleSide, blending: AdditiveBlending, depthWrite: false }, o2)), this.uniforms = { frame: { value: null !== (t2 = null == o2 ? void 0 : o2.frame) && void 0 !== t2 ? t2 : 0 }, useMap: { value: !!(null == o2 ? void 0 : o2.map) }, map: { value: null !== (r2 = null == o2 ? void 0 : o2.map) && void 0 !== r2 ? r2 : null }, color: { value: new Color(null !== (n2 = null == o2 ? void 0 : o2.color) && void 0 !== n2 ? n2 : "#FFFFFF") }, stripCount: { value: null !== (c2 = null == o2 ? void 0 : o2.stripCount) && void 0 !== c2 ? c2 : 20 }, fresnelExponent: { value: null !== (i2 = null == o2 ? void 0 : o2.fresnelExponent) && void 0 !== i2 ? i2 : 2 }, holographicOffset: { value: null !== (v2 = null == o2 ? void 0 : o2.holographicOffset) && void 0 !== v2 ? v2 : 1.25 }, smoothEdgeStart: { value: null !== (x2 = null == o2 ? void 0 : o2.smoothEdgeStart) && void 0 !== x2 ? x2 : 0.8 }, smoothEdgeEnd: { value: null !== (a2 = null == o2 ? void 0 : o2.smoothEdgeEnd) && void 0 !== a2 ? a2 : 0 }, glitchStrength: { value: null !== (l2 = null == o2 ? void 0 : o2.glitchStrength) && void 0 !== l2 ? l2 : 0.25 }, glitchMin: { value: null !== (f2 = null == o2 ? void 0 : o2.glitchMin) && void 0 !== f2 ? f2 : 0.3 }, glitchMax: { value: null !== (g = null == o2 ? void 0 : o2.glitchMax) && void 0 !== g ? g : 1 }, glitchFrequencyLow: { value: null !== (s = null == o2 ? void 0 : o2.glitchFrequencyLow) && void 0 !== s ? s : 1 }, glitchFrequencyMid: { value: null !== (m = null == o2 ? void 0 : o2.glitchFrequencyMid) && void 0 !== m ? m : 3.45 }, glitchFrequencyHigh: { value: null !== (d = null == o2 ? void 0 : o2.glitchFrequencyHigh) && void 0 !== d ? d : 8.76 } }, this.setupUniformProperties();
  }
  setupUniformProperties() {
    Object.keys(this.uniforms).forEach((o2) => {
      Object.defineProperty(this, o2, { get: () => {
        var e;
        return null === (e = this.uniforms[o2]) || void 0 === e ? void 0 : e.value;
      }, set: (t2) => {
        "color" === o2 && t2 instanceof Color ? this.uniforms[o2].value.set(t2) : "map" === o2 ? (this.uniforms[o2].value = t2, this.uniforms.useMap.value = null !== t2) : this.uniforms[o2].value = t2;
      }, enumerable: true, configurable: true });
    });
  }
};
function v(e, t2) {
  const { uniforms: r2 = {}, vertexShader: n2 = "", fragmentShader: c2 = "" } = t2 || {};
  Object.keys(r2).forEach((o2) => {
    if (!(o2 in e)) {
      let t3 = r2[o2];
      Object.defineProperty(e, o2, { get: () => t3.value, set: (e2) => t3.value = e2, enumerable: true, configurable: true });
    }
  }), e.onBeforeCompile = (e2) => {
    const { uniforms: t3 } = e2;
    if (Object.keys(r2).forEach((e3) => !(e3 in t3) && (t3[e3] = r2[e3])), n2) {
      const { header: t4, mainBody: r3 } = o(n2);
      e2.vertexShader = `${t4}
${e2.vertexShader}`.replace("#include <project_vertex>", `
             ...
             { 
              ...
              ${r3.replace(/s3_position/g, "s3_normal")}
              objectNormal = s3_normal;
              #ifdef USE_TANGENT
              vec3 s3_tangent = objectNormal;
              ${r3.replace(/s3_position/g, "s3_tangent")}              
              objectTangent = s3_tangent;
              #endif          
              }`);
    }
    if (c2) {
      const { header: t4, mainBody: r3 } = o(c2);
      e2.fragmentShader = `${t4} 
 ${e2.fragmentShader.trim().slice(0, -1)} ${r3}}`;
    }
  };
}
var x = "vec2 truchetPattern(vec2 s,float i){i=fract((i-.5)*2.);return mix(mix(s,vec2(1.)-s,step(.5,i)),vec2(1.-s.x,s.y),step(.75,i));}";
...
export {
  ...
  i as MeshHolographicMaterial,
  c as MeshMatcapMaterial,
  r as MeshPhysicalMaterial,
...
//# sourceMappingURL=shader3.js.map
